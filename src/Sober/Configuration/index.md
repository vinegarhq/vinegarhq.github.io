...
| `graphics_optimization_mode`        | "quality" - Roblox will give desktop-like graphics, default; "balanced" - Roblox will strike strike a balance between high and low graphics quality; "performance" Roblox will maximize performance at the cost of graphics quality, resulting in noticeably lower LOD fidelity and lower texture quality.                                                        | `"balanced"` |
