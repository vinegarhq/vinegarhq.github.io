...
> *If SSE4.2 is not highlighted, you should also check for `grep "sse4_1" /proc/cpuinfo` as you are able to also run Sober with SSE4.1 support despite the absense of SSE4.2.
